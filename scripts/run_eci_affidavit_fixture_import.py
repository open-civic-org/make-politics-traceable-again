#!/usr/bin/env python3
"""Import the fixture ECI Form-26 affidavit (no live network)."""
...
FIXTURE = ROOT / "tests/fixtures/eci/affidavits/asha_verma_form26.txt"
...
def main() -> None:
    ...
    with session_scope() as session:
        collector = EciAffidavitCollector(ctx, session=session, fixture_path=FIXTURE)
        stats = collector.run()
        logger.info("ECI affidavit fixture import complete: %s", stats.as_dict())
